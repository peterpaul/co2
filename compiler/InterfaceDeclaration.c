...
O_IMPLEMENT(InterfaceDeclaration, void, generate, (void *_self))
{
  ...
  /* generate the class */
  O_CALL(new_methods, map_args, InterfaceDeclaration_generate_method_definition, self);
  fprintf(out, "\n");
  ...
  O_CALL(new_methods, map_args, InterfaceDeclaration_generate_method_registration, self);
  fprintf(out, "\n\n");
  ...
  O_CALL(methods, map_args, InterfaceDeclaration_generate_method_implementation, self);
  fprintf(out, "\n");
